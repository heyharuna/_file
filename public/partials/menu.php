<nav class="nav desktopNav is-desktop">
    <div class="container">
        <div class="nav-left nav-menu">
            <a class="nav-item logo" href="index.php">
                <img src="#" alt="Timetodoyou">
            </a>
            <a  href="#" class="nav-item is-tab is-hidden-mobile">WOMEN</a>
            <a href="#" class="nav-item is-tab is-hidden-mobile">MEN</a>
            <a href="#" class="nav-item is-tab is-hidden-mobile">ACCESSORIES</a>
            <a href="#" class="nav-item is-tab is-hidden-mobile">STORE</a>
        </div>
    ...
    <div class="mobile_menu_list">
        <ul>
            ...
            <ul class="submenu_products">
                <li class="h5"><a href="#">- WOMEN</a></li>
                <li class="h5"><a href="#">- MEN</a></li>
                <li class="h5"><a href="#l">- ACCESSORIES</a></li>
            </ul>
